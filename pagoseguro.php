<?php
/*
 * Plugin Name: GatewayPro Payment Gateway For WooCommerce
 * Plugin URI: https://docs.dyner24.com/index.php/docs/dyner24-documentacion/plugins-modulos/woocommerce/
 * Description: GatewayPro Payment Gateway
 * Author: shell931
 * Author URI: https://github.com/shell931/
 * Developer: shell931
 * Developer URI: https://github.com/shell931/
 * Version: 1.0.1
...
function pagoseguro_init_gateway_class()
{
    ...
    class PagoSeguro_Gateway extends WC_Payment_Gateway
    {
        ...
        public function __construct()
        {
            ...
            $this->method_title       = __('Gateway Pro', 'pagoseguro');
            $this->method_description = __('Gateway Pro Payment Checkout', 'pagoseguro'); // will be displayed on the options page
        ...
        public function admin_options()
        {
            if ($this->isValidForUse()) {
                ...
                $icon = 'https://imagesd24.s3.us-east-2.amazonaws.com/GatewayPro.png';
        ...
        */
        ...
        {
            $icon      = 'https://imagesd24.s3.us-east-2.amazonaws.com/GatewayPro.png';
            $icon_html = '<img src="'.esc_attr($icon).'" alt="'.esc_attr__('PagoSeguroDescription').'" style="float: none; max-width: 90px; background-color: #fffbfb; border-radius: 5px; padding: 3px;" class="mb-2"/>';

            return apply_filters('woocommerce_gateway_icon', $icon_html, $this->id);
        }

        /*
        * Validate order and Redirect GatewayPro
        */
