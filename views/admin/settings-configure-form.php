<?php
/**
 * Settings for GatewayPro Gateway.
 */
...
return [
    'description' => [
        ...
        'type'        => 'textarea',
        'default'     => 'Pay with your credit card via our super-cool payment gateway GatewayPro.',
    ],
    'pagoseguroTestMode' => [
        'title'       => __('PAGOSEGURO_TEST_MODE', 'pagoseguro'),
        'type'        => 'checkbox',
        'label'       => 'Debe estar desactivado si en la configuración de GatewayPro esta en modo producción',
        'default'     => 'yes',
    ],
    'pagoseguroAccountId' => [
